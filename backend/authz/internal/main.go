...
import (
	"achobeta-svc/backend/authz/config"
	"achobeta-svc/backend/authz/internal/service"
	server "achobeta-svc/backend/common/lib"
	"achobeta-svc/backend/common/lib/tlog"
	"achobeta-svc/backend/common/pkg/utils"
	permissionv1 "achobeta-svc/backend/proto/gen/go/authz/permission/v1"
	"log"
	"os"
	"os/signal"
	"syscall"
